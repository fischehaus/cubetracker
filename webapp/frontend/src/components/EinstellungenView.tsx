// EinstellungenView (W.ia-einstellungen-bereich, 2026-05-31) — „Einstellungen":
// geräte-spezifische App-Präferenzen (localStorage), eigener Bereich im
// UserMenu (Pseudo-Tab `einstellungen`, NICHT in der Haupt-TabBar — analog
// profil/konto/admin/tester). Gruppiert in zwei Blöcke:
//   - Aussehen (Skin/Card-Stil, Timer-/Drill-Schriftgröße, Scramble-Bild)
//   - Timer & Eingabe (Spacebar/Hold, Inspection, Multi-Phase-Splits)
//
// Früher der `settings`-Subtab von „Konto & Daten" (Komponente SettingsPanel,
// jetzt aufgelöst). Die Konto-Sicherheit (Email/Passwort/Account-Löschen) ist
...
interface Props {
  /** Zurück in die App (Statistik-Tab) — „einstellungen" hat keine Haupt-TabBar. */
  onBack: () => void;
}
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-4">
        {/* W.skin-cyberpunk-mvp: Skin-Picker (Background-Bilder + Card-Stil). */}
        <SkinPickerCard />
        ...
        {/* Scramble-Bild (Phase W.scramble-image) */}
      ...
      {/* ================= GRUPPE: TIMER & EINGABE ================= */}
      <GroupHeader>{t("einstellungenView.groupTimer")}</GroupHeader>
      <div className="space-y-4">
        {/* Spacebar / Hold-Time */}
        <Section

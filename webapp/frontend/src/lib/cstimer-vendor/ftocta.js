...
// Original file: src/js/solver/ftocta.js
// Original copyright (C) 2010-2024 csTimer contributors, GPL-3.0-or-later
//
// Modifications:
//   - Top-level `var ftosolver = (function...)()` rewritten to
//     `window.ftosolver = (function...)()` so the IIFE-global survives the
//     ESM-module wrapping that Vite applies (identical to skewb.js etc.).
//   - No other functional changes — pure mechanical adaptation.
//
// FTO random-state solver. Dependency: only window.mathlib (+ window.DEBUG
// from shim). Loaded by ./index.ts BEFORE scramble_fto.js (which uses
// ftosolver). Do not import directly.

/* eslint-disable */
/* @ts-nocheck */
window.ftosolver = (function() {
	"use strict";

...
// Original file: src/js/scramble/scramble.js
// Original copyright (C) 2010-2024 csTimer contributors, GPL-3.0-or-later
//
// Modifications:
//   - Top-level `var NAMESPACE = (function...)()` rewritten to
//     `window.NAMESPACE = (function...)()` so that the IIFE-globals
//     survive the ESM-module wrapping that Vite applies.
//   - No other functional changes — pure mechanical adaptation.
//
// Loaded in correct order by ./index.ts (shim → mathlib → scramble →
// puzzle-modules). Do not import these files directly.
...
window.scrMgr = (function(rn, rndEl) {

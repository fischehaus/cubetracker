...
// Original file: src/js/scramble/scramble_fto.js
// Original copyright (C) 2010-2024 csTimer contributors, GPL-3.0-or-later
//
// Modifications: none (pure side-effect module — registers scrMgr.reg('ftoso')
// plus the fto* trainer subsets; bare ftosolver/mathlib/scrMgr resolve against
// window.*). Loaded by ./index.ts AFTER ftocta.js. Do not import directly.

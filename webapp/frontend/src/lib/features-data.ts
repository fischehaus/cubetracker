...
export const FEATURE_CATEGORIES: FeatureCategory[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Charts: Trends über Zeit, Distribution-Verteilung, taegliche Aktivität",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Auto-Refresh: bei jeder Anmeldung pruefen wir im Hintergrund ob neue News verfügbar sind — beim ersten Dashboard-Aufruf sind sie da, ohne Wartezeit",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Automatische Snapshots vor groesseren Änderungen (Restore/Bulk-Import)",
    ],
  },
  {

...
class FeedSource:
    ...
    # Max wie viele Items pro Fetch von dieser Source übernommen werden
...
FEED_SOURCES: list[FeedSource] = [
    ...
    # - YouTube-Channels (J Perm, CubeHead etc.): könnten via
    #   https://www.youtube.com/feeds/videos.xml?channel_id=X eingebunden
    #   werden — aber das würde Tutorial-Spam erzeugen. Lieber kuratierte
